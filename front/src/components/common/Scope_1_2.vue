...
<template>
  <div :id="Options.idName">
    <DxChart id="Scope_1_2" :customize-point="customizePoint" :customize-label="customizeLabel" :data-source="Options.loadedData" title="">
      <DxSeries argument-field="baseDt" value-field="scope1" name="Scope1" type="bar" color="#E8E5D3" />
      <DxSeries argument-field="baseDt" value-field="scope2" name="Scope2" type="bar" color="#F3C848" />
