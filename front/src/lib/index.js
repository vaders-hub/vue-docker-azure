...
import { assessmentEvaluationController } from './class/content/AssessmentEvaluation.js'
...
const hander = {
  contentReady() {
    ...
    assessmentEvaluationController.init(selector.assessEval)
  },
